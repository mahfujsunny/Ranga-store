...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
    <div class="single-product card bg-info">
        ...
        <div class="text-danger bg-warning rounded-3">
          <p class="d-inline mx-5 p-0 fw-bold"><i class="fas fa-user"></i> ${product.rating.count}</p> 

          <p class="d-inline mx-5 p-0 fw-bold"><i class="fas fa-star-half-alt"></i> ${product.rating.rate}</p>
        </div>
